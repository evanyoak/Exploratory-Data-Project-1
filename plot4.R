...
axis(1, at = c(0, 1500, 2880), labels=c("Thu", "Fri", "Sat"))
legend(x = "topright", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), cex = .6, lwd = 1, col = c("black", "red", "blue"))

#4th plot
plot(finaldata$Global_reactive_power, type = "l", xaxt = "n", xlab = "datetime", ylab = "Global_reactive_power")
axis(1, at = c(0, 1500, 2880), labels=c("Thu", "Fri", "Sat"))
